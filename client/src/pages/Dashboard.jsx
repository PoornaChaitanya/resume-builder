...
const Dashboard = () => {
  ...
  const deleteResume = async (resumeId) => {
    const confirm = window.confirm(
      "Are you sure you want to dekete this resume?",
    );
    if (confirm) {
    ...
    <div>
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="flex gap-4">
          ...
          items-center justify-center rounded-lg gap-2 text-slate-600 border 
          border-dashed border-slate-300 group hover:border-indigo-500 
            ...
            >
              ...
              >
                ...
                <input
                  ...
                  required
                />
                <button className="w-full py-2 bg-green-600 text-white rounded hover:green-700 transition-colors">
                  Create Resume
                </button>
                <XIcon
